...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"RetailAdvantages\": () => (/* binding */ RetailAdvantages)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar RetailAdvantages = /*#__PURE__*/function () {\n  function RetailAdvantages(el) {\n    _classCallCheck(this, RetailAdvantages);\n\n    this.el = el;\n    if (!this.el) return;\n    this.advantagesNumbers = this.el.querySelectorAll('.retail__advantages-number');\n  }\n\n  _createClass(RetailAdvantages, [{\n    key: \"changeBrandColor\",\n    value: function changeBrandColor(currentBrend) {\n      if (currentBrend === 0) {\n        this.advantagesNumbers.forEach(function (number) {\n          number.style.color = '#E31235';\n        });\n      } else {\n        this.advantagesNumbers.forEach(function (number) {\n          number.style.color = '#76BC21';\n        });\n      }\n    }\n  }]);\n\n  return RetailAdvantages;\n}();\n\n//# sourceURL=webpack:///./js/components/retail/retailAdvantages.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"RetailFooter\": () => (/* binding */ RetailFooter)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar RetailFooter = /*#__PURE__*/function () {\n  function RetailFooter(el) {\n    _classCallCheck(this, RetailFooter);\n\n    this.el = el;\n    if (!this.el) return;\n    this.mvideoTitle = this.el.querySelector('.retail__footer-title-shop-mvideo');\n    this.eldoradoTitle = this.el.querySelector('.retail__footer-title-shop-eldorado');\n  }\n\n  _createClass(RetailFooter, [{\n    key: \"showActiveBrandTitle\",\n    value: function showActiveBrandTitle(currentBrand) {\n      if (currentBrand === 0) {\n        this.mvideoTitle.classList.remove('hide');\n        this.eldoradoTitle.classList.add('hide');\n      }\n\n      if (currentBrand === 1) {\n        this.mvideoTitle.classList.add('hide');\n        this.eldoradoTitle.classList.remove('hide');\n      }\n    }\n  }]);\n\n  return RetailFooter;\n}();\n\n//# sourceURL=webpack:///./js/components/retail/retailFooter.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"RetailMission\": () => (/* binding */ RetailMission)\n/* harmony export */ });\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../index */ \"./js/index.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar RetailMission = /*#__PURE__*/function () {\n  function RetailMission(el) {\n    _classCallCheck(this, RetailMission);\n\n    this.el = el;\n    if (!this.el) return;\n    this.missionButton = this.el.querySelector('.retail__mission-button');\n    this.missionButton.addEventListener('click', this.scrollToBrandsBlock.bind(this));\n  }\n\n  _createClass(RetailMission, [{\n    key: \"scrollToBrandsBlock\",\n    value: function scrollToBrandsBlock() {\n      (0,_index__WEBPACK_IMPORTED_MODULE_0__.smothScrollingToBlock)(_index__WEBPACK_IMPORTED_MODULE_0__.retailBrands, _index__WEBPACK_IMPORTED_MODULE_0__.headerItPage);\n    }\n  }]);\n\n  return RetailMission;\n}();\n\n//# sourceURL=webpack:///./js/components/retail/retailMissionBlock.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"RetailQuote\": () => (/* binding */ RetailQuote)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar RetailQuote = /*#__PURE__*/function () {\n  function RetailQuote(el) {\n    _classCallCheck(this, RetailQuote);\n\n    this.el = el;\n    if (!this.el) return;\n    this.mvideo = this.el.querySelector('.mvideo');\n    this.eldorado = this.el.querySelector('.eldorado');\n  }\n\n  _createClass(RetailQuote, [{\n    key: \"switchTab\",\n    value: function switchTab(currentBrand) {\n      if (currentBrand === 0) {\n        this.mvideo.classList.remove('hide');\n        this.eldorado.classList.add('hide');\n      }\n\n      if (currentBrand === 1) {\n        this.mvideo.classList.add('hide');\n        this.eldorado.classList.remove('hide');\n      }\n    }\n  }]);\n\n  return RetailQuote;\n}();\n\n//# sourceURL=webpack:///./js/components/retail/retailQuote.js?");
