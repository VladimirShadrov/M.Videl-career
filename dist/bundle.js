...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"ItHubSlider\": () => (/* binding */ ItHubSlider)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar ItHubSlider = /*#__PURE__*/function () {\n  function ItHubSlider(slideNumber, slides, slideRowPosition, row, slideCounter) {\n    _classCallCheck(this, ItHubSlider);\n\n    this.currentSlideNumber = slideNumber;\n    this.slides = slides;\n    this.currentSlideRowPosition = slideRowPosition;\n    this.slidesRow = row;\n    this.slidesCounterField = slideCounter;\n  }\n\n  _createClass(ItHubSlider, [{\n    key: \"showNextSlide\",\n    value: function showNextSlide() {\n      if (this.currentSlideNumber <= this.slides.length) {\n        var activeSlide = this.slides.find(function (item) {\n          return item.classList.contains('swiper-slide-active');\n        });\n        var currentIndes = +activeSlide.attributes['aria-label'].textContent.slice(0, 1);\n        this.currentSlideNumber = +this.slides[currentIndes].attributes['aria-label'].textContent.slice(0, 1);\n        var slideWidht = parseFloat(activeSlide.style.width);\n        this.currentSlideRowPosition = currentIndes * slideWidht;\n        this.slidesRow.style.transition = 'transform 0.3s';\n        this.slidesRow.style.transform = \"translate3d(\".concat(-this.currentSlideRowPosition + 'px', \", 0px, 0px)\");\n        this.slides.forEach(function (slide) {\n          slide.classList.remove('swiper-slide-active');\n        });\n        this.slides[currentIndes].classList.add('swiper-slide-active');\n      }\n    }\n  }, {\n    key: \"showPreviousSlide\",\n    value: function showPreviousSlide() {\n      if (this.currentSlideNumber >= 1) {\n        var activeSlide = this.slides.find(function (item) {\n          return item.classList.contains('swiper-slide-active');\n        });\n        var currentIndes = +activeSlide.attributes['aria-label'].textContent.slice(0, 1);\n        this.currentSlideNumber = +this.slides[currentIndes - 2].attributes['aria-label'].textContent.slice(0, 1);\n        var slideWidht = parseFloat(activeSlide.style.width);\n        this.currentSlideRowPosition = (currentIndes - 2) * slideWidht;\n        this.slidesRow.style.transition = 'transform 0.3s';\n        this.slidesRow.style.transform = \"translate3d(\".concat(-this.currentSlideRowPosition + 'px', \", 0px, 0px)\");\n        this.slides.forEach(function (slide) {\n          slide.classList.remove('swiper-slide-active');\n        });\n        this.slides[currentIndes - 2].classList.add('swiper-slide-active');\n      }\n    }\n  }, {\n    key: \"setCurrentSlideNumber\",\n    value: function setCurrentSlideNumber() {\n      this.slidesCounterField.textContent = this.currentSlideNumber;\n    }\n  }]);\n\n  return ItHubSlider;\n}();\n\n//# sourceURL=webpack:///./js/helpers/itHubSlider.js?");
